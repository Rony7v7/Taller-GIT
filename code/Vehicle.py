class Vehicle:
    def __init__(self, brand, model, year, kilometers, current_status, type_fuel, service_date):
        self.brand = brand
        self.model = model
        self.year = year
    ...
    def __str__(self):
        return f'{self.brand} {self.model} {self.year} {self.kilometers} {self.current_status} {self.type_fuel} {self.service_date}'
